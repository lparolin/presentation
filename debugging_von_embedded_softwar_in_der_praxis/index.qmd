...
Der Begriff ‚Bug‘ für technische Fehler lässt sich bis ins 19. Jahrhundert zurückverfolgen.
...
> _Debugging bedeutet in der Regel herauszufinden, warum ein Entwurf nicht wie geplant funktioniert. Troubleshooting hingegen bedeutet herauszufinden, was an einer bestimmten Instanz eines Produkts defekt ist, wenn das Produktdesign an sich als korrekt gilt._ (nach Agans, 2002)
...
## Reproduzierbarkeit des Defekts

Ein zentrales Thema beim Debugging eingebetteter Software ist die _Reproduzierbarkeit_ von Defekts.
...
## Timing-Probleme sichtbar machen {auto-animate=true}
...
:::{.callout-note appearance="simple" title="Niemals printf im Echtzeitpfad verwenden!"}

- `printf` ist **blockierend** – jede Ausgabe kann mehrere Millisekunden beanspruchen.
- Die Laufzeit hängt von **Nachrichtenlänge und Formatierung** ab und ist deswegen nicht deterministisch.
...
::: {.fragment}
**Vergleich Pin-Toggling gegen printf Ansatz:**
...
- Pin-Toggling zeigt nur Start/Ende
- Für detaillierte Analyse: **Trace-Library**

### Vorteile

- Zeitstempel für Start/Stop und Subfunktionen
- Live-Trace oder Offline-Analyse
- Minimaler Overhead
...
- Zeitstempel in jedem Eintrag
- Log-Level: ERROR, WARNING, INFO, DEBUG
- Aktivierung per Compile-Flags oder Runtime-Konfiguration
- Effiziente Analyse durch strukturierte Logs (CSV, JSON)

::: {.callout-note appearance="simple"}
Nur durch präzises Trace und standardisierte Logs lassen sich Timing-Probleme sichtbar machen.
:::
