...
::: {.callout-note appearance="simple" .fragment .fade-up fragment-index="3"}
**Solche Fehler müssen bereits in der Entwicklungsphase entdeckt werden!**
:::

<!-- :::{.fragment .fade-out fragment-index="3"}

{{< include _link_Beispiel2.qmd >}}
...
## Defekte infolge von Kommunikations- und Interpretationsfehlern {auto-animate=true footer=false}
...
::: {.callout-note appearance="simple" .fragment fragment-index="1"}
Richtige Antwort: **B**.
:::
...
# Backup  {background-image="Figuren/First_Computer_Bug_1945.jpg" background-opacity="0.3" background-color="black"}
